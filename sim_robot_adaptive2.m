function dxdt = sim_robot_adaptive2(t,x,gamma,Kd,lambda,q_traj,Y,Y_vars,q_ddot,vars)
...
q_ddot_t = double(subs(q_ddot,vars,[q;q_dot;-tau]));
dxdt = [q_dot; q_ddot_t; a_hat_dot];
end
